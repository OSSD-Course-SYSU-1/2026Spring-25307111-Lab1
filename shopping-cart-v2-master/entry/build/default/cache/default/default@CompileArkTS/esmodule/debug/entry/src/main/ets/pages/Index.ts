...
class ProductItem {
    ...
    image: Resource = { "id": 16777235, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" };
    @Trace
...
class ProductItemView extends ViewV2 {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda, extraInfo) {
        super(parent, elmtId, extraInfo);
        this.initParam("productItem", (params && "productItem" in params) ? params.productItem : new ProductItem({ "id": 16777235, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, '', 0));
        this.countChange = () => {
        };
        this.finalizeConstruction();
    }
    public resetStateVarsOnReuse(params: Object): void {
        this.resetParam("productItem", (params && "productItem" in params) ? params.productItem : new ProductItem({ "id": 16777235, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, '', 0));
...
class ShoppingCart extends ViewV2 {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda, extraInfo) {
        ...
        this.money = 0;
        this.productList = [
            new ProductItem({ "id": 16777235, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, 'Matterhorn', 28898),
            new ProductItem({ "id": 16777236, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, '珠峰日照金山', 8888),
            new ProductItem({ "id": 16777237, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, '瑞士滑雪', 16666),
            new ProductItem({ "id": 16777238, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, 'Emerald Lake', 28898),
            new ProductItem({ "id": 16777239, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, 'Cliffs of Moher', 16666),
            new ProductItem({ "id": 16777235, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, 'Matterhorn', 28898),
            new ProductItem({ "id": 16777236, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, '珠峰日照金山', 8888),
            new ProductItem({ "id": 16777237, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, '瑞士滑雪', 16666),
            new ProductItem({ "id": 16777238, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }, 'Emerald Lake', 28898),
    ...
    addProduct(): void {
        const images = [
            ...
            { "id": 16777239, "type": 20000, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" }
        ];
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            // Stack为堆叠容器，可以使标题栏和总计栏堆叠在商品列表上方
            Stack.backgroundColor({ "id": 16777233, "type": 10001, params: [], "bundleName": "com.example.shoppingcartv2", "moduleName": "entry" });
            // Stack为堆叠容器，可以使标题栏和总计栏堆叠在商品列表上方
